...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Furnice | Karyawan Login</title>
                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">Anda Login Sebagai Karyawan</p>
                                </div>

                                <?php echo $this->session->flashdata('pesan') ?>
                                <form method="post" action="<?php echo base_url('c_auth/login_karyawan')?>" class="user">

                                    <div class="mb-2">
                                        <label for="emailaddress" class="form-label">Username</label>
                                        <input class="form-control" type="text" name="ky_username" id="ky_username" required="" placeholder="Masukkan Username Anda">
                                        <?php echo form_error('ky_username', '<div class="text-danger small"', '</div>') ?>
                                    </div>

                                    <div class="mb-2">
                                        <label for="password" class="form-label">Password</label>
                                        <div class="input-group input-group-merge">
                                            <input type="password" name="ky_password" id="ky_password" class="form-control" placeholder="Masukkan Username Anda">
                                            <div class="input-group-text" data-password="false">
                                                <span class="password-eye"></span>
                                            </div>
                                            <?php echo form_error('ky_password', '<div class="text-danger small"', '</div>') ?>
                                        </div>
                                    </div>
                                ...
                                <div class="text-center d-grid mt-2">
                                    <a href="<?php echo base_url('c_auth/login_pelanggan'); ?>" class="btn btn-outline-primary waves-effect waves-light" type="submit"> Saya, Pelanggan </a>
                                </div>
                                <br>
                            </div> <!-- end card-body -->
                        </div><!-- end card -->
